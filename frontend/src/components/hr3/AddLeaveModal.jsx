      ...
      <DialogContent className="max-w-lg">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div>
            ...
            <Input type="text" value={leaveData.employee} onChange={e => setLeaveData({ ...leaveData, employee: e.target.value })} required />
          </div>
          <div>
            <label className="font-bold">Leave Type</label>
            <Input type="text" value={leaveData.type} onChange={e => setLeaveData({ ...leaveData, type: e.target.value })} required />
          </div>
          <div>
          ...
          <div>
            ...
            <Textarea value={leaveData.reason} onChange={e => setLeaveData({ ...leaveData, reason: e.target.value })} required />
          </div>
          <DialogFooter>
